...
int main()
{
  ...
  /*	cout << "¬ведите строку ";
	cin >> s;
	cout << s << endl;
	getline(cin,s1);  // это очень надо, чтобы очистить буфер ввода (дл€ примера ввести "маша очень вкусно ела")
	cout << s1<<endl;

	cout<<"¬ведите строку с пробелами: \n";
	getline(cin,s1,'\n');  // отлично вводит всю строку до указанного символа
	cout<<s1<<endl;     */
...
/*	cout << "Enter s= ";
 ...
 /*
   ...
   */
   ...
   cout << "ќбратное преобразование. ¬ведите число: ";
   double i;
   cin  >> i;
   cout << "to_string(i)= "<< to_string(i)<< endl;
	...
	system("pause");              // чистит буфер ввода, ну либо просто передвигает вирт курсор
